  ...
  export default function LeadsManagement() {
    ...
    const [userDetailsDialog, setUserDetailsDialog] = useState<{ open: boolean; lead: Lead | null }>({ open: false, lead: null });
    const [editingUserDetails, setEditingUserDetails] = useState<UserDetailsUpdate>({
      leadId: '',
      user_name: '',
      user_mobile: '',
      user_email: '',
    ...
    const downloadReport = async () => {
      ...
      try {
        ...
        link.setAttribute('download', `leads_report_${startDate}_to_${endDate}.csv`);
    ...
    const getStatusIcon = (status: string) => {
      switch (status) {
        ...
        case 'applied': return <TrendingUpIcon sx={{ fontSize: 16 }} />;
        case 'rejected': return <AssignmentIcon sx={{ fontSize: 16 }} />;
      ...
      <Box sx={{ p: 3 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Manage and track all product leads with comprehensive user details and status updates
          </Typography>
        </Box>
            ...
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="body2" sx={{ opacity: 0.9 }}>Contacted</Typography>
                </Box>
                <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', width: 56, height: 56 }}>
            ...
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box>
                  ...
                  <Typography variant="body2" sx={{ opacity: 0.9 }}>Applied</Typography>
                </Box>
                <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', width: 56, height: 56 }}>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: '#f8f9fa' }}>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem' }}>User Details</TableCell>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem' }}>Finsang ID</TableCell>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem' }}>Product</TableCell>
                  <TableCell sx={{ fontWeight: 600, fontSize: '0.875rem' }}>Contact Info</TableCell>
              ...
              <TableBody>
                {leads.map((lead) => {
                  ...
                  return (
                    <TableRow key={lead.id} sx={{ '&:hover': { backgroundColor: '#f8f9fa' } }}>
                      <TableCell>
                ...
                <Card sx={{ mb: 3, bgcolor: '#f8f9fa', borderRadius: 2 }}>
                  <CardContent sx={{ py: 2 }}>
                    ...
                    <Typography variant="body2" color="textSecondary">
                      <strong>User:</strong> {editDialog.lead.user_name} ({editDialog.lead.user_mobile})
                    </Typography>
                  </CardContent>
                </Card>
          ...
          <DialogContent sx={{ pt: 3 }}>
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_name: e.target.value }))}
                sx={{ 
              ...
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_mobile: e.target.value }))}
                sx={{ 
                  minWidth: 'calc(50% - 12px)',
                  '& .MuiOutlinedInput-root': {
                    borderRadius: 2,
              ...
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_email: e.target.value }))}
                sx={{ 
                  minWidth: 'calc(50% - 12px)',
                  '& .MuiOutlinedInput-root': {
                    borderRadius: 2,
              ...
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_age: parseInt(e.target.value) || 0 }))}
                sx={{ 
                  minWidth: 'calc(50% - 12px)',
                  '& .MuiOutlinedInput-root': {
                    borderRadius: 2,
              ...
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_pincode: e.target.value }))}
                sx={{ 
                  minWidth: 'calc(50% - 12px)',
                  '& .MuiOutlinedInput-root': {
                    borderRadius: 2,
              ...
              <TextField
                ...
                onChange={(e) => setEditingUserDetails(prev => ({ ...prev, user_income: parseFloat(e.target.value) || null }))}
          ...
          <DialogActions sx={{ p: 3, pt: 1 }}>
            ...
            <Button 
              ...
              sx={{ 
                ...
                background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)',
                '&:hover': {
                  background: 'linear-gradient(135deg, #3dd870 0%, #2ee6c4 100%)',
                }
              }}
            >
              Save User Details
        ...
        >
          ...
          <DialogContent sx={{ pt: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
              Report will include: Finsang ID, User Details, Product Info, Status, Date, and Notes
            </Typography>
          </DialogContent>
          <DialogActions sx={{ p: 3, pt: 1 }}>
            <Button 
